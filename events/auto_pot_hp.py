...
class AutoPotHP(BaseEvent):
    ...
    def __init__(self, game, name="AUTO_POT_HP", event_type=EventType.AUTO_POT, resource=Resource.HP_POTION, priority=Priority.HIGH):
        super().__init__(game, name, event_type, resource, priority)

    def check_condition(self) -> bool:
        super().check_condition()
        hp_percent = EVENT.get_config_be(Prop.PERCENT, self)
