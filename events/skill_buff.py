...
class SkillBuff(BaseEvent):
    ...
    def check_condition(self) -> bool:
        ...
        buff = self.game_event.char.next_buff_to_use(APP_CONTROLLER.job_buff_skills)
        if buff is None:
            return False
    ...
    def execute_action(self):
        ...
        (job_id, buff_id, _) = self.game_event.char.next_buff_to_use(APP_CONTROLLER.job_buff_skills)
